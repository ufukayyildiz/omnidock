...
const BUCKET_INDEX_PAGE_LIMIT = 12;
const BUCKET_INDEX_OBJECT_MAX_BYTES = 6 * 1024 * 1024;
const BUCKET_INDEX_TEXT_MAX_BYTES = 2 * 1024 * 1024;
const BUCKET_INDEX_AI_MAX_BYTES = 4 * 1024 * 1024;
const BUCKET_INDEX_TEXT_DEADLINE_MS = 5_000;
